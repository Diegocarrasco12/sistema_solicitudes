      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <button class="btn btn-info btn-sm text-white" onclick="verDetalle('<?php echo $row['id']; ?>')">Ver Detalle</button>
            </td>
            <td>
              <button class="btn btn-warning btn-sm w-100" onclick="reabrirTicket('<?php echo $row['id']; ?>', '<?php echo $row['tipo']; ?>')">Reabrir</button>
            </td>
          </tr>
          <?php endwhile; ?>
        </tbody>
